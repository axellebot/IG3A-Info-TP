...
J'ai écrit une fonction \mintinline{cpp}{rechercheValeurRec()} qui prend deux paramètres, le premier étant un pointeur sur le noeud d'un arbre, et le second une valeur v à chercher. La fonction renvoie 1 si la valeur v est contenue dans l’arbre, et 0 sinon. Le déroulement de la fonction est le suivant :
% rechercheValeurRec
\inputminted[linenos,firstline=38,lastline=42]{cpp}{../sources/cpp/TP3-4/arbresFctRecursives.c}

J'ai écrit une fonction \mintinline{cpp}{rechercheNoeudRec()} qui prend deux paramètres, le premier étant un pointeur sur  le noeud d'un arbre, et le second une valeur v à chercher. La fonction renvoie le noeud contenant la valeur v, et null sinon. Le déroulement de la fonction est le suivant :
% rechercheNoeudRec
